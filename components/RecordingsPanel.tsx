    ...
    <div>
      ...
      <ul className="space-y-2">
        {recs.map((r) => {
          ...
          return (
            <li key={r.surah} className="flex items-center justify-between gap-3 rounded-lg bg-white px-3 py-2 ring-1 ring-ink/5">
              ...
              <div className="flex shrink-0 items-center gap-1.5">
                ...
                <button onClick={() => void remove(r)} aria-label="Delete" title="Delete" className="rounded-full px-2 py-1 text-xs text-red-600 ring-1 ring-red-200 hover:bg-red-50">
                  ✕
                </button>
              </div>
            </li>
