  ...
  return (
    <button
      ...
      className={`flex items-center gap-1.5 rounded-full px-3.5 py-1.5 text-sm font-semibold ring-1 transition ${
        playing ? "bg-ink text-white ring-ink" : "bg-surface-2 text-ink/80 ring-ink/20 hover:bg-ink/5"
      }`}
    >
...
function MistakeRow({
  ...
  return (
    <li className="flex items-center justify-between gap-3 rounded-lg bg-surface-2 px-3 py-2 ring-1 ring-ink/5">
