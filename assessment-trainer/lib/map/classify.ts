...
export function describe(
  ...
  return {
    ...
    agreeMeans: `Agreeing describes someone who: ${highSide.charAt(0).toLowerCase()}${highSide.slice(1)}`,
    disagreeMeans: `Disagreeing describes someone who: ${lowSide.charAt(0).toLowerCase()}${lowSide.slice(1)}`,
